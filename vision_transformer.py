    ...
    def forward_features(self, x, task_id=-1, cls_features=None, train=False):
        ...
        if self.grad_checkpointing and not torch.jit.is_scripting():
            ...
            if self.use_g_prompt or self.use_e_prompt:
                ...
                self.g_prefix_feature = {}
                self.e_prefix_feature = {}
                # self.g_prefix_gradient= {}
                # self.e_prefix_gradient= {}
                ...
                for i, block in enumerate(self.blocks):
                    if i in self.g_prompt_layer_idx:
                        ...
                        self.g_prefix_feature[i] = {"key": block.attn.key_}
                        # self.g_prefix_gradient[i] = {"key": block.attn.key_.grad}
                        ...
                        if self.use_prefix_tune_for_e_prompt:
                            ...
                            self.e_prefix_feature[i] = {"key": block.attn.key_}
                            # self.e_prefix_gradient[i] = {"key": block.attn.key_.grad}
                        else:
